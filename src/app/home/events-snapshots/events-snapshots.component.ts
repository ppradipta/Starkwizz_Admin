...
@Component({
  selector: 'app-events-snapshots',
  templateUrl: './events-snapshots.component.html',
  styleUrls: ['./events-snapshots.component.scss'],
})
export class EventsSnapshotsComponent implements OnInit {
  EventVideoList: any[] = [];
