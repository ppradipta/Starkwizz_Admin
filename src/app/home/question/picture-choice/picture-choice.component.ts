...
@Component({
  selector: 'app-picture-choice',
  templateUrl: './picture-choice.component.html',
  styleUrls: ['./picture-choice.component.scss'],
})
export class PictureChoiceComponent implements OnInit {
  ...
  generateSequence() {
    let options = this.utilityService.generateOptionSequence(this.numberOfOptions, 'TEXT_IMG');
